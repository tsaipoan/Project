...
1. Twitch.tv project video: https://www.youtube.com/watch?v=WVb2_HFjGRw

2. Felis Investigations: http://webdev.cse.msu.edu/~tsaipoan/step8/
Login Email: test@test
Password: test

3. Hangman: http://webdev.cse.msu.edu/~tsaipoan/step9/

4. Simon: http://webdev.cse.msu.edu/~tsaipoan/step10/simon.php

5. Movie info site: http://webdev.cse.msu.edu/~tsaipoan/ajaxnoir/
Login ID: tsaipoan
Password: super477
