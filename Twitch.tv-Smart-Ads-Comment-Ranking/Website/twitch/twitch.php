...
<div class="purple">
    ...
    <?php
    if(isset($_SESSION['channelName']) || isset($_REQUEST['c'])) {
        echo "<p><i class=\"fa fa-eye\"></i>&nbsp".$viewers."&nbsp&nbsp&nbsp <i class=\"fa fa-group\"></i>&nbsp".$info["channel"]["views"]."&nbsp&nbsp&nbsp<i class=\"fa fa-heart\"></i>&nbsp".$info["channel"]["followers"]."</p>";
    ...
    <div class="main">
        ...
        <form method="post">
            ...
            <div class="ad">
                <iframe name='ads'
                    <?php
                        echo 'src="http://35.9.22.102/new_ad/adAjax.php"';
                    ?>
                        scrolling="no">
                </iframe>
            </div>
