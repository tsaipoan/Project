...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWndEx)
	...
	ON_COMMAND(ID_EDIT_HALORDTEXTBUBBLE, &CMainFrame::OnEditHalordtextbubble)
	ON_COMMAND(ID_EDIT_SPARTYTEXTBUBBLE, &CMainFrame::OnEditSpartytextbubble)
END_MESSAGE_MAP()
...
void CMainFrame::Initialize()
{
	...
	mTextBubbleHarold = factory.GetHaroldTextBubble();
	mTextBubbleSparty = factory.GetSpartyTextBubble();
    //
...
void CMainFrame::OnEditHalordtextbubble()
{
	mTextBubbleHarold->ShowDialogBox();
	Invalidate();
}


void CMainFrame::OnEditSpartytextbubble()
{
	mTextBubbleSparty->ShowDialogBox();
	Invalidate();
}
