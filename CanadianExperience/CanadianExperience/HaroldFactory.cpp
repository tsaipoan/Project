...
std::shared_ptr<CActor> CHaroldFactory::Create()
{
	...
	auto knife = make_shared<CProb>(L"Knife", L"images/knife.png");
	knife->SetCenter(Point(10, 30));
	knife->SetPosition(Point(-20, 96));
	knife->SetRotation(70.6);
	rarm->AddChild(knife);
